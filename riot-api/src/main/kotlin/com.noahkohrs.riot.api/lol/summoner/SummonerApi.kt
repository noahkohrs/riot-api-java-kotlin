...
public class SummonerApi(
    ...
    public fun getSummonerByRsoPuuid(
        rsoPUUID: String,
    ): SummonerResponse = SummonerResponse(apiClient.getSummonerByRsoPuuid(rsoPUUID))

    /**
     * Get a summoner by account ID.
     */
    public fun getSummonerByAccountId(
        encryptedAccountId: String,
    ): SummonerResponse = SummonerResponse(apiClient.getSummonerByAccountId(encryptedAccountId))
    ...
    ): SummonerResponse = SummonerResponse(apiClient.getSummonerByPuuid(encryptedPUUID))
     ...
     */
    public fun getSummonerBySummonerId(
        encryptedSummonerId: String,
    ): SummonerResponse = SummonerResponse(apiClient.getSummonerBySummonerId(encryptedSummonerId))
