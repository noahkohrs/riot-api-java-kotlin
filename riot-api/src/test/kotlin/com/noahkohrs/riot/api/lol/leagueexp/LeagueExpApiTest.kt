...
class LeagueExpApiTest {
    ...
    fun getLeagueEntries() {
        ...
        val p1 = leagueExp.getLeagueEntries(LoLRankedQueue.RankedSoloQueue, LoLTier.GOLD, LoLDivision.I)
        val p10 = leagueExp.getLeagueEntries(LoLRankedQueue.RankedSoloQueue, LoLTier.GOLD, LoLDivision.I, 10)
